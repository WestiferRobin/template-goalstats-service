...
not at request teardown. Domain operations close their SQLAlchemy sessions; the
foundation request-session facility retains its rollback/close contract. Import
